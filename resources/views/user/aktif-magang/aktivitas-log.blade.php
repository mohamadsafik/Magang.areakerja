    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="nav-link scrollto" href="/user">Halaman Utama</a></li>
                    @guest
                    @if (Route::has('login'))
                        ...
                        <div class="card-body">
                            ...
                            <form action="/simpan-aktivitas" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" style="height: 100px" name="aktivitas_log" required></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
